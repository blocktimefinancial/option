...
async function updateSmartContract(scDetailsObj, quote) {
  // Create the transaction to update the smart contract
    ...
    let tx = new stellar_sdk.TransactionBuilder(kp, { fee, networkPassphrase: SorobanClient.Networks.STANDALONE })
    .addOperation(scDetailsObj.sc_contract.call(scDetailsObj.sc_func, toSorobanArgs(quote)))
    .setTimeout(60)
    .build();
